  ...
  const [trips,setTrips] = useState<Trip[] | null>(null);
   useEffect(() => {
    const apicalling = async () => {
      try {
        const pastridedata = await api.post("/admin/ClientPastRides",{id:id});
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-200">View Client's ride history and earnings</p>
      </div>
