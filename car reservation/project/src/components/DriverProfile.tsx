...
const DriverProfile: React.FC = () => {
  ...
  useEffect(() => {
    const fetchDriver = async () => {
      ...
      try {
        const response = await api.post("/admin/searchdriver",{id});
    ...
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-lg font-bold text-gray-900">{driver.available ? 'Active' : 'Inactive'}</p>
            </div>
          </div>
        </div>
            ...
            {driver.address?.street && (
              <div className="flex items-center ">
                ...
                <div >
                  ...
                  <p className="text-gray-900">{driver.address?.street}</p>
                </div>
              </div>
            )}
            <div className="flex items-center">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="flex space-x-4">
          <button className="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors" onClick={()=> navigate(`/driverRide/${id}`)}>
            View Ride History
          </button>
        </div>
      </div>
